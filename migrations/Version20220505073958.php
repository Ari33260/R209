 ...
 */
final class Version20220505073958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE diplome (id INT AUTO_INCREMENT NOT NULL, ville_id INT NOT NULL, intitule_id INT NOT NULL, univ_id INT NOT NULL, but_id INT NOT NULL, INDEX IDX_EB4C4D4EA73F0036 (ville_id), INDEX IDX_EB4C4D4E6729EDCE (intitule_id), INDEX IDX_EB4C4D4E52B4B886 (univ_id), INDEX IDX_EB4C4D4EB8914BA4 (but_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
